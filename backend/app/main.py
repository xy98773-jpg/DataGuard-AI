...
from app.api import approval, database, dataset, trace, web, workflow
...
for router in (dataset.router, workflow.router, trace.router, approval.router, database.router, web.router):
